...
import com.liuxuecanada.liuxuecanada.CustomizedComponent.ChartComponentLib.listener.PieRadarChartTouchListener;
import com.liuxuecanada.liuxuecanada.CustomizedComponent.ChartComponentLib.utils.SelectionDetail;
...
public abstract class PieRadarChartBase<T extends ChartData<? extends DataSet<? extends Entry>>>
    ...
    public void calculateOffsets() {
        ...
        if (mLegend != null && mLegend.isEnabled()) {
            ...
            } else if (mLegend.getPosition() == Legend.LegendPosition.RIGHT_OF_CHART) {
            ...
            } else if (mLegend.getPosition() == Legend.LegendPosition.LEFT_OF_CHART_CENTER) {
